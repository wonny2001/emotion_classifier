...
def integer_csv(rows, schema, delimiter):
    ...
    for column in schema:
        ...
        #clock 0
            ...
            generators.append(lambda: random.uniform(0.0123137,0.2342542))
        ...
        #sns 2
            ...
            generators.append(lambda: random.uniform(0.054488143, 0.3493962))
        elif column == 'result2':
        ...
        #official 4
            ...
            generators.append(lambda: random.uniform(0.15619683, 0.250209165))
